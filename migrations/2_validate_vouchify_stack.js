...
async function deployCoreContracts({ deployer, from, coldWallet }) {
...
module.exports = async function (deployer, network, from) {
    ...
    const {
        ...
        walletFactory,
        membershipFactory,
    } = await deployCoreContracts({ deployer, from, coldWallet });
    ...
    if (network === "mainnet") {
        console.log("Mainnet core contracts deployed successfully.");
    } else {
